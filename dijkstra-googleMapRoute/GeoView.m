...
- (void)drawRect:(CGRect)rect
{
    ...
    if (self.delegate != nil && [self.delegate respondsToSelector:@selector(drawRectByCustom:)]) {
        [self.delegate drawRectByCustom:self];
    }
}
...
- (NSMutableArray *) changeUIColorToRGB:(UIColor *)color
{
    ...
    for (int i=0; i<n; i++)
    {
        [resultArr addObject:[NSNumber numberWithFloat:rgba[i]]];
    }
    return resultArr;
}
